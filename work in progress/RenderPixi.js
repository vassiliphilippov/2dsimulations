...
(function() {
    ...
    RenderPixi.create = function(options) {
        Matter.Common.warn('RenderPixi.create: Matter.RenderPixi is deprecated (see docs)');
        ...
        if (Matter.Common.isElement(render.element)) {
            ...
            Matter.Common.warn('No "render.element" passed, "render.canvas" was not inserted into document.');
        }
    ...
    RenderPixi.setBackground = function(render, background) {
        if (render.currentBackground !== background) {
            ...
            if (isColor) {
                ...
                var color = Matter.Common.colorToNumber(background);
    ...
    RenderPixi.constraint = function(render, constraint) {
        ...
        if (Matter.Common.indexOf(container.children, primitive) === -1)
    ...
    var _createBodyPrimitive = function(render, body) {
        var bodyRender = body.render,
            ...
            strokeStyleWireframeIndicator = Matter.Common.colorToNumber('#CD5C5C'),
            part;
