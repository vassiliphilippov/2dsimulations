...
//Todo: optimize performance using imagepixes: http://jsfiddle.net/loktar/63QZz/ https://stackoverflow.com/questions/23468218/draw-10-000-objects-on-canvas-javascript
...
(function() {
    ...
    ChemistryRender.drawAtom = function(render, atom, radius, particle, singleAtomParticle, context) {
        ...
        AtomDrawer.drawAtom(context, atom.position, atom.angle, radius, atom.render.fillStyle, labelText);
    };
